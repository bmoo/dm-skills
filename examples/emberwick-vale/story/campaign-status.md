...
**Progress marker:** Session 1 played (The Unlit Lantern). Session 2 not
yet in prep.

## In motion

- The Cinder Court's collection route continues uphill; two more lanterns
  will fail before session 2 unless the party moves first.
...
- **Landed (session 1):** the failures are deliberate — a reversed wick
  was recovered at the warehouse.
- **Pending:** the failures map to a route; the route ends at the
  guildhall basement; the Court still has standing inside the guild.
