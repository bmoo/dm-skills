...
The render-directive and render-token lints are sync obligations
`docs/campaign-contract.md` already declares; they are mechanically checkable
rather than trusted to a commit-message convention.
