...
| lint/relative-links-resolve | Every relative link in a skill file resolves to a file that exists — including cross-skill loads (`../spotlight/doctrine.md`) | parse |
